...
#  subject(:gem_install) {
#    RulesRuby::GemSet.new(name:     gem_tuple.name,
...
module RulesRuby
  GEM_HOME = "/tmp/gem-home.#{Process.pid}"

  RSpec.describe GemSet do
    #before(:all) { FileUtils.rm_rf(GEM_HOME) if Dir.exist?(GEM_HOME) }
    #
