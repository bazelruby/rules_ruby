...
module RulesRuby
  SPEC_GEM_HOME = Tempfile.new("/tmp/bazel-dir.#{Process.pid}").path.freeze
  SPEC_HOME = Dir.pwd.freeze

  RSpec.describe Bundle do
    let(:gem_home) { ::RulesRuby::SPEC_GEM_HOME }
    let(:pwd) { ::RulesRuby::SPEC_HOME }


  #  before(:all) do
  #    FileUtils.rm_rf(::RulesRuby::SPEC_GEM_HOME )
  #    FileUtils.mkdir_p(::RulesRuby::SPEC_GEM_HOME )
  #    Dir.chdir(::RulesRuby::SPEC_GEM_HOME )
  #  end
  #
  #  after(:all) do
